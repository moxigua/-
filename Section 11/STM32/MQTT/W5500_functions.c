...
uint8_t macAddress[6]={0x00,0x08,0xdc,0x11,0x12,0x16};
//uint8_t macAddress[6]={0x00,0x23,0x54,0x66,0x68,0x6A};
/*定义默认IP信息*/
uint8_t local_ip[4]={192,168,1,110};												/*定义W5500默认IP地址*/
uint8_t subnet[4]={255,255,255,0};												/*定义W5500默认子网掩码*/
uint8_t gateway[4]={192,168,1,1};													/*定义W5500默认网关*/
//uint8_t local_ip[4]={202,198,110,223};												/*定义W5500默认IP地址*/
//uint8_t subnet[4]={255,255,255,0};												/*定义W5500默认子网掩码*/
//uint8_t gateway[4]={202,198,110,1};													/*定义W5500默认网关*/
